...
function selectPlace(id){selectedId=id;const place=effectivePlace(id);$("#placeId").value=id;$("#room").value=place.room;$("#floor").value=place.floor;$("#name").value=place.name;$("#category").value=place.category;$("#description").value=place.description||"";$("#usageInfo").value=place.usageInfo||"";$("#active").checked=place.active!==false;$("#searchable").checked=place.searchable!==false;$("#editorTitle").textContent=`${place.room}호 ${place.name}`;renderList();message($("#saveMessage"),"");}
